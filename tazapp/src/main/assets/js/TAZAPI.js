var TAZAPI = (function() {
	...
	return (function() {
		...
		function pageReady(percentSeen, position) {
			console.log(percentSeen,position);
         	ANDROIDAPI.pageReady(percentSeen, position, "");
        }
		function pageReady(percentSeen, currentPage, numberOfPages) {
			console.log(percentSeen, currentPage, numberOfPages);
			//console.log("pageReady");
			// JsBridge.call( "articlePageReady", undefined, percentSeen,
			// position );
			//ANDROIDAPI.pageReady(percentSeen, position);
			ANDROIDAPI.pageReady(percentSeen, currentPage, numberOfPages);
		}
		...
		function removeValueDir(path) {
			console.log("removeValueDir",path);
		...
		function setBookmark(artname, isBookmarked) {
			console.log("setBookmark",artname,isBookmarked);
		...
		function menuStatusCallback(currentStatus) {
			console.log("menuStatusCallback",currentStatus);
